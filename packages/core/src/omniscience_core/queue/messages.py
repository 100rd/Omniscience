...
class Message[T: BaseModel]:
    ...
    __slots__ = ("_ack", "_nak", "_term", "metadata", "payload", "subject", "published_at")
...
class EntityUpsertEvent(BaseModel):
    ...
    is_backfill: bool = Field(False, description="Flag indicating if this event was generated by the reconciler to clear parked status.")
