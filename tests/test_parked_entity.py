...
from omniscience_retrieval.probabilistic_scoring import calculate_probabilistic_confidence, calculate_probabilistic_incident_confidence
...
def test_incident_scoring_penalized_when_parked():
    ...
    conf_normal, prov_normal = calculate_probabilistic_incident_confidence(
        alert=alert,
    ...
    conf_parked_res, prov_parked_res = calculate_probabilistic_incident_confidence(
        alert=alert,
        classified=classified_parked,
        max_depth=3
    )
    
    assert conf_parked_res < conf_normal
    assert prov_parked_res == True
